...
const DigiTools_Card = ({productsDataPromise, cartProduct, setCartProduct}) => {
    const Product = use(productsDataPromise);
    ...
    return (
        <div className='mt-28 container mx-auto flex'>
            <div className='justify-center items-center text-center mx-auto'>
                ...
                <p className='mt-4 text-[#627382] md:w-135 mx-auto'>Choose from our curated collection of premium digital products designed to boost your productivity and creativity.</p>
                <div className='mt-5'>
                    ...
                    >Cart({cartProduct.length})</button>
                </div>
                <div>
                    <div className=' mt-10'>
                    {cardType === "Products" ? 
                       ...
                       setCartProduct={setCartProduct}></Products> :
                       <CartSection
                       cartProduct={cartProduct}
